...
function Questions() {
    ...
    const [tags, setTags] = useState(["tag a", "tag b", "tag c", "tag this and that", "kill me"]);
            ...
            <div className="tab-items">
                {ques.map((item) =>(
                    <div className="tab-item">
                        <QuestionCard content={item.content} title={item.title} username={item.user_name} user_url={item.user_profile_pic} tags={item.tags}/>
                    </div>
                    )                            
                )}
