...
function ScrollContainer(props) {
  ...
  var temp = companies.filter(function (comp) { return (comp.name.toLowerCase().includes(props.value.toLowerCase()) ||comp.type.toLowerCase().includes(props.value.toLowerCase()) )});
  // console.log(temp);
  return (
